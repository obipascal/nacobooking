...
<head>
    <meta charset="UTF-8"/>
    <title>Naco Booking System</title>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-189112490-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-189112490-1');
</script>
