...
<div class="bravo_header">
    <div class="{{$container_class ?? 'container'}}">
		...
		<div  class="search-custom"><form action="../../../search" class="row"> <input name="q" class="form-control col-7" value="<?php if(isset($_GET["q"])){echo $_GET["q"];}?>" placeholder="Search..."/> <button class="btn btn-secondary col-4 ml-1"><i class="fa fa-search"></i></button> </form></div>
    </div>
	...
	<div  class="mobile-search"><form action="../../../search" class="row"> <input name="q" class="form-control col-7" value="<?php if(isset($_GET["q"])){echo $_GET["q"];}?>" placeholder="Search..."/> <button class="btn btn-secondary col-4 ml-1"><i class="fa fa-search"></i></button> </form></div>
