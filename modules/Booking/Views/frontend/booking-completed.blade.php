                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="notice-success">
                            <p class="line1"><span>{{$booking->first_name}},</span>
                                {{__('your booking has been successfully received!')}}
                            </p>
                        <p class="line2">{{__('Booking details has been sent to:')}} <span>{{$booking->email}}</span> {{ __('awaiting approval. You will recieve an email shortly with the payment link to make payment for your reservation once the booking has been approved. Thank you!') }}</p>
                        </div>
