<div class="form-checkout" id="form-checkout" >
    ...
    <div class="form-actions">
        <button id="startCheck" type="button" class="btn btn-danger">{{__('Make Payment')}}
           
        </button>
    </div>
    
    <div class="form-actions" style="display:none">
        <button id="completedCheck" class="btn btn-danger" @click="doCheckout">{{__('I\'ve made payment!')}}
