            ...
            <div class="row booking-success-notice">
                <div class="col-lg-8 col-md-8">
                    <div class="d-flex align-items-center">
                        ...
                        <p class="line2">{{__('Booking details has been sent to our team for approval.')}} {{ __('You will recieve an email shortly with the payment link to make payment for this reservation once the booking has been approved. Thank you!') }}</p>
                        </div>
